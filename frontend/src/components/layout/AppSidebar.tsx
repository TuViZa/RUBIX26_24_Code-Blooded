...
const features = [
  ...
  { title: "Smart OPD", url: "/smart-opd", icon: Users, role: ['admin', 'hospital_staff', 'doctor', 'nurse'] },
  { title: "OPD Queue", url: "/opd-queue", icon: Users, role: ['admin', 'hospital_staff', 'doctor', 'nurse'] },
  { title: "Bed Availability", url: "/beds", icon: Bed, role: ['admin', 'hospital_staff', 'nurse'] },
  { title: "Admission Workflow", url: "/admission", icon: UserCheck, role: ['admin', 'hospital_staff', 'doctor', 'nurse'] },
  { title: "Hospital Network", url: "/network", icon: Building2, role: ['admin', 'hospital_staff'] },
  { title: "Inventory Tracking", url: "/inventory", icon: Package, role: ['admin', 'hospital_staff'] },
  ...
  { title: "Blood Bank", url: "/blood-bank", icon: Droplets, role: ['admin', 'hospital_staff'] },
  ...
  { title: "Ambulance Detection", url: "/ambulance-detection", icon: Ambulance, role: ['admin', 'hospital_staff'] },
